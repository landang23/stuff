...
# MAGIC %sql
# MAGIC USE lgeorge.building

# COMMAND ----------

# List our raw PDF docs
volume_folder =  f"/Volumes/lgeorge/building/auc"
...
(df.writeStream
  ...
  .table('lgeorge.building.pdf_raw').awaitTermination())
...
# MAGIC CREATE TABLE IF NOT EXISTS lgeorge.building.pdf_docs (
...
(spark.readStream.table('pdf_raw')
  ...
  .writeStream
    ...
    .table('pdf_docs').awaitTermination())

# COMMAND ----------

# MAGIC %sql
# MAGIC SELECT * FROM pdf_docs
...
source_table_fullname = f"lgeorge.building.pdf_docs"
# Where we want to store our index
vs_index_fullname = f"lgeorge.building.auc_pdf_docs_index"
...
question = "Where is the Glacier Gas Plant located?"
